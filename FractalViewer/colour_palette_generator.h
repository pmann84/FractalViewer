...
namespace palette
{
   namespace create
   {
      static colour_palette blue()
      {
         return colour_palette(
            {
               { 247.0f / 255.0f, 251.0f / 255.0f, 255.0f / 255.0f, 1.0f },
               { 222.0f / 255.0f, 235.0f / 255.0f, 247.0f / 255.0f, 1.0f },
               { 198.0f / 255.0f, 219.0f / 255.0f, 239.0f / 255.0f, 1.0f },
               { 158.0f / 255.0f, 202.0f / 255.0f, 225.0f / 255.0f, 1.0f },
               { 107.0f / 255.0f, 174.0f / 255.0f, 214.0f / 255.0f, 1.0f },
               { 66.0f / 255.0f, 146.0f / 255.0f, 198.0f / 255.0f, 1.0f },
               { 33.0f / 255.0f, 113.0f / 255.0f, 181.0f / 255.0f, 1.0f },
               { 8.0f / 255.0f, 69.0f / 255.0f, 148.0f / 255.0f, 1.0f }
            }
         );
      }

      //static colour_palette green()
      //{
      //   return colour_palette(
      //      {
      //          {0xf7, 0xfc, 0xf5, 0xff},
      ...
      //static colour_palette chromajs()
      //{
      //   return colour_palette(
      //      {
      //         {0xff, 0xff, 0xe0, 0xff},
      ...
      //static colour_palette spectral()
      //{
      //   return colour_palette(
      //      {
      //         {0xd5, 0x3e, 0x4f, 0xff},
